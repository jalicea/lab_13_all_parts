...
print("Mr DJ,")
print("Listen to what I say,")
print("I've got a track, a request I want you to play.")
print("Alright lady,")
print("Give me a track name.")
print("If I've got it then spin it for you okay?")
print("Mr DJ, \nListen to what I say,\nI've got a track, a request I want you to play. \nAlright lady,\nGive me a track name.\nIf I've got it then spin it foe you okay?")